...
class Archive:
    ...
    Attributes:
        ...
        batch_id (Union[None, UUID, Unset]): Batch ID associated with the file.
    ...
    archive_id: Union[Unset, UUID] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        batch_id: Union[None, Unset, str]
        if isinstance(self.batch_id, Unset):
            batch_id = UNSET
        elif isinstance(self.batch_id, UUID):
        ...
        if not isinstance(self.archive_id, Unset):
        ...
        if archive_id is not UNSET:
            field_dict["archive_id"] = archive_id
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_batch_id(data: object) -> Union[None, UUID, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        _archive_id = d.pop("archive_id", UNSET)
        archive_id: Union[Unset, UUID]
        if isinstance(_archive_id, Unset):
            archive_id = UNSET
        else:
            archive_id = UUID(_archive_id)
